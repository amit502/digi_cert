...
from ecdsa import SigningKey as BitcoinMessage, VerifyingKey as VerifyMessage
...
class ReceiptIntegrityChecker(VerificationCheck):
    ...
    def do_execute(self):
        ...
        self.merkle_proof['@context']='https://w3id.org/chainpoint/v2'
...
class EmbeddedSignatureChecker(VerificationCheck):
    def __init__(self, signing_key, content_to_verify, signature_value, chain=Chain.ethereum_ropsten):
...
class AuthenticityChecker(VerificationCheck):
    ...
    def __init__(self, transaction_signing_key, transaction_signing_date, issuer_key_map):
        ...
        print(transaction_signing_key, transaction_signing_date, issuer_key_map)        
        for k in issuer_key_map:
            print(k)

    def do_execute(self):
        w3 = Web3(HTTPProvider('https://ropsten.infura.io/WY2IpmvumcQOxVcCxUW4'))
        self.transaction_signing_key= w3.toChecksumAddress(self.transaction_signing_key)
        for k in self.issuer_key_map:
                print(k)
        print(self.transaction_signing_key) 
